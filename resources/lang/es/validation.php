...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'license_plate' => 'placa',
        'old_license_plate' => 'placa anterior',
        'registration_starting' => 'partida registral',
        'condition' => 'condición',
        'owner_type' => 'tipo propietario',
        ...
        'temporary_validity' => 'vig. temp.',
        'category' => 'categoría',
        'vehicle_brand_id' => 'marca',
        'color_id' => 'color',
        'fuel_id' => 'combustible',
        'rolling_form' => 'Form. Rodante',
        ...
        'useful_load' => 'carga útil',
        'length' => 'longitud',
        'height' => 'altura',
        'width' => 'ancho',
        'vehicle_type_id' => 'tipo vehículo',
        'insurance_date_of_due' => 'fecha vencimiento seg.',
        'insurance_id' => 'seguro',

        'process_id' => 'proceso',
        'opening_date' => 'fecha apertura',
        'final_item_warehouse_id' => 'almacén para producto final',
        'process_warehouse_id' => 'almacén para proceso',
        'origin_warehouse_id' => 'origen de la materia prima',
        'detail' => 'detalle',
        'incoming_items' => 'prod. Entrantes',
        'result_items' => 'resultados',
