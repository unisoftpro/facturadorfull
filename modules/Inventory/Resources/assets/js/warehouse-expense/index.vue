            ...
            <div class="card-body">
                <data-table :resource="resource">
                    ...
                    <tr slot-scope="{ index, row }">
                        ...
                        <td class="text-right">
                            <button  type="button" class="btn waves-effect waves-light btn-xs btn-primary" @click.prevent="clickDownload(row.id)">Descargar</button>
                        </td>
...
<script>
    ...
    export default {
        ...
        created() {
            this.title = "Salidas almacén";
        },
        methods: {
            clickDownload(id) {
                window.open(`/${this.resource}/download/${id}`, '_blank');
            },
