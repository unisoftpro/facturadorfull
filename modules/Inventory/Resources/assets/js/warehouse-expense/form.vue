<template>
    <div class="card mb-0 pt-2 pt-md-0">
        <div class="card-header bg-info">
            <h3 class="my-0">Salida de almacén</h3>
        </div>
        <div class="tab-content">
            <form autocomplete="off" @submit.prevent="submit">
                <div class="form-body">
                    ...
                    <div class="row">
                         <div class="col-lg-4">
                            <div class="form-group" :class="{'has-danger': errors.warehouse_expense_id}">
                                <label class="control-label">Almacén de Salida</label>
                                <el-select v-model="form.warehouse_expense_id" filterable>
                                    <el-option v-for="option in warehouses" :key="option.id" :value="option.id" :label="option.description"></el-option>
                                </el-select>
                                <small class="form-control-feedback" v-if="errors.warehouse_expense_id" v-text="errors.warehouse_expense_id[0]"></small>
                            </div>
                        </div>
                         ...
                         <div class="col-lg-4">
                            <div class="form-group" :class="{'has-danger': errors.warehouse_destination_id}">
                                ...
                                <el-select v-model="form.warehouse_destination_id" filterable>
                                    <el-option v-for="option in warehouses" :key="option.id" :value="option.id" :label="option.description"></el-option>
                                </el-select>
                         ...
                         <div class="col-lg-4">
                            <div class="form-group" :class="{'has-danger': errors.warehouse_expense_reason_id}">
                                <label class="control-label">Motivo</label>
                                <el-select v-model="form.warehouse_expense_reason_id" filterable @change="changeWarehouseIncomeReason">
                                    <el-option v-for="option in warehouse_income_reasons" :key="option.id" :value="option.id" :label="option.description"></el-option>
                                </el-select>
                                <small class="form-control-feedback" v-if="errors.warehouse_expense_reason_id" v-text="errors.warehouse_expense_reason_id[0]"></small>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-2">
                            <div class="form-group" :class="{'has-danger': errors.work_order_id}">
                                ...
                                <el-select @change="changeOT" v-model="form.work_order_id" filterable>
        ...
        methods: {
            ...
            async getTables(){
                ...
                await this.$http.get(`/${this.resource}/tables`)
                    .then(response => {
                        ...
                        this.warehouse_income_reasons = response.data.warehouse_expense_reasons
            ...
            initForm() {
                ...
                this.form = {
                    ...
                    warehouse_expense_id: null,
                    warehouse_expense_reason_id: null,
            ...
            async submit() {
                ...
                if(this.form.warehouse_expense_id == this.form.warehouse_destination_id)
                {
                    return this.$message.warning("Almacen destino debe ser diferente a Almacen salida.")
                }
