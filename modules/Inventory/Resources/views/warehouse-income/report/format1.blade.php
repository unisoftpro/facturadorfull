    ...
    <body>
            ...
            <table style="border:1px solid black">
                <tr>
                    <th colspan="2" style="text-align: center !important"  class="title">
                        <strong>Ingreso Nro {{ str_pad($record->number, 7, "0", STR_PAD_LEFT) }}</strong>
                    </th>
                </tr>
                <tr>
                    <th class="td-custom">
                        <strong>Almacén: </strong>{{$record->warehouse->description}}
                    </th>
                    <th class="td-custom">
                ...
                <tr>
                    <th class="td-custom">
                        <strong>Concepto: </strong>{{$record->warehouse_income_reason->description}}
                    </th>
                    <th class="td-custom">
                        <strong>Documento Ref: </strong>{{$record->observation}}
                    </th>
                </tr>
                <tr>
                    <th class="td-custom">
        ...
        <div style="margin-top:0px; margin-bottom:20px;">
            <table>
                ...
                <tfoot >
                    <tr>
                    <td colspan="5" > Ingresado por {{$record->user->name}}</td>
