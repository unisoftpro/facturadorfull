...
<table class="full-width mt-5">
    <tr>
        <td width="15%">Almacén:</td>
        <td width="45%">{{ $warehouse->description }}</td>
        <td width="25%">Fecha Ingreso:</td>
        <td width="15%">{{ $document->date_of_issue }}</td>
    </tr>
    <tr>
        <td width="15%">Concepto:</td>
        <td width="45%">{{ $document->warehouse_income_reason->description }}</td> 
    </tr>
    <tr>
    ...
    <tr>
        ...
        @if ($document->purchase_order)
            <td width="15%">Ord. Trab:</td>
            <td width="45%">{{ $document->purchase_order->number }}</td> 
        @endif 
    </tr> 
