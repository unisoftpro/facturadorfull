@php
    ...
    $warehouse_expense = $document->warehouse_expense->description;
    $warehouse_destination = $document->warehouse_destination->description;
...
<table class="full-width">
    <tr>
        ...
        <td width="30%" class="border-box py-4 px-2 text-center">
            <h5 class="text-center">Ingreso Nro: {{ $tittle }}</h5>
        </td>
    </tr>
</table>
<table class="full-width mt-5">
    <tr>
    <td width="15%">Almacén Destino:</td>
        <td width="45%">{{ $warehouse_destination }}</td>
    </tr>
    <tr>
        <td width="15%">Almacén Salida:</td>
        <td width="45%">{{ $warehouse_expense }}</td>
        <td width="25%">Fecha Ingreso:</td>
        <td width="15%">{{ $document->date_of_issue }}</td>
    </tr>
    <tr>
        <td width="15%">Concepto:</td>
        <td width="45%">{{ $document->warehouse_expense_reason->description }}</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td width="45%">{{ $document->currency_type_id }}</td>
    </tr>
