...
class TenantWarehouseExpenseItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('warehouse_expense_items', function (Blueprint $table) {
            ...
            $table->foreign('warehouse_expense_id')->references('id')->on('warehouse_expense')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('warehouse_expense_items');
    }
}
